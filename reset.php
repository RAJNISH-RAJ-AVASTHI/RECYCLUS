...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $details=mysqli_query($con,"SELECT name,email FROM users WHERE email='$email_reg'");
    if (mysqli_num_rows($details)>0) { //if the given email is in database, ie. registered
        ...
        $msg = "Please copy the link and paste in your browser address bar". "\r\n"."http://localhost/pro/forgot_password_reset.php?key=".$key."&email=".$email_reg;
        $headers = 'From:Recyclus Corporation Limited' . "\r\n";
